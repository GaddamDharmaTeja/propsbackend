...
public class ImportController {
    ...
    private String category(
        ...
        if (
                value.matches(
                        ".*(bigbasket|blinkit|zepto|dmart|grocery|mart|supermarket|reliance fresh|more supermarket).*"
                )
        ) {
        ...
        if (
                value.matches(
                        ".*(zomato|swiggy|restaurant|cafe|food|dominos|pizza|mcdonald|kfc|eatclub).*"
                )
        ) {
        ...
        if (
                value.matches(
                        ".*(uber|ola|rapido|fuel|petrol|diesel|metro|bus|transport|cab).*"
                )
        ) {
        ...
        if (
                value.matches(
                        ".*(salary|payroll|income|credited salary|sal).*"
                )
        ) {
        ...
        if (
                value.matches(
                        ".*(netflix|prime video|hotstar|spotify|youtube|subscription).*"
                )
        ) {
        ...
        if (
                value.matches(
                        ".*(electricity|water bill|gas|broadband|internet|airtel|jio|vi|recharge).*"
                )
        ) {
        ...
        if (
                value.matches(
                        ".*(hospital|pharmacy|medical|doctor|apollo|health).*"
                )
        ) {
